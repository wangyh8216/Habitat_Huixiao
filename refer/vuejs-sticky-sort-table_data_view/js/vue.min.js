...
function(e, t) {
	...
	function Ne(e, t, n) {
		if ("function" == typeof t && (t = t.options), function(e, t) {
			...
			if (n) {
				...
				else if (s(n)) for (var a in n) i = n[a], o[_(a)] = s(i) ? i : {
					type: i
				};
				e.props = o
			}
	...
	function jt(e) {
		...
		}(e, t.computed), t.watch && t.watch !== G &&
		function(e, t) {
			for (var n in t) {
				var r = t[n];
	...
	function Ft(e, t) {
		...
		else if (o(e)) for (s = Object.keys(e), r = new Array(s.length), i = 0, a = s.length; i < a; i++) c = s[i], r[i] = t(e[c], c, i);
	...
	function ln(e) {
		...
		e.extend = function(e) {
			...
			return (a.prototype = Object.create(n.prototype)).constructor = a, a.cid = t++, a.options = Ne(n.options, e), a.super = n, a.options.props &&
			function(e) {
	...
	function(t) {
		t.prototype._init = function(t) {
			var n = this;
			n._uid = sn++, n._isVue = !0, t && t._isComponent ?
			function(e, t) {
	...
	function Ai(e, t, n) {
		...
		if (!i || Array.isArray(r)) {
			for (var o, a, s = 0, c = e.options.length; s < c; s++) if (a = e.options[s], i) o = j(r, Si(a)) > -1, a.selected !== o && (a.selected = o);
	...
	function Ro(e, t) {
		...
		function(e) {
			...
			for (t = 0, n = c.length; t < n; t++) if (r = i = c[t].name, o = c[t].value, To.test(r)) if (e.hasBindings = !0, (a = Uo(r)) && (r = r.replace(Mo, "")), Lo.test(r)) r = r.replace(Lo, ""), o = fr(o), s = !1, a && (a.prop && (s = !0, "innerHtml" === (r = _(r)) && (r = "innerHTML")), a.camel && (r = _(r)), a.sync && _r(e, "update:" + _(r), Cr(o, "$event"))), s || !e.component && Ao(e.tag, e.attrsMap.type, r) ? hr(e, r, o) : mr(e, r, o);
			...
			if ("input" === e.tag) {
				...
				if ((r[":type"] || r["v-bind:type"]) && (n = br(e, "type")), r.type || n || !r["v-bind"] || (n = "(" + r["v-bind"] + ").type"), n) {
					var i = $r(e, "v-if", !0),
						...
						s = $r(e, "v-else-if", !0),
						c = Ko(e);
					Ho(c), yr(c, "type", "checkbox"), Ro(c, t), c.processed = !0, c.
					if = "(" + n + ")==='checkbox'" + o, Bo(c, {
						exp: c.
						if,
						block: c
					});
	...
	function oa(e, t) {
		...
		if (t.modifiers) {
			var i = "",
				o = "",
				a = [];
			for (var s in t.modifiers) if (ra[s]) o += ra[s], ea[s] && a.push(s);
			else if ("exact" === s) {
				var c = t.modifiers;
